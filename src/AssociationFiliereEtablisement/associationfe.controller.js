...
const associationfe  = require("./associationfe.model");
...
exports.associationfePost = async (req, res) => {
  try {
    ...
    const newassociationfe  = new associationfe  (result);
    await newassociationfe  .save();
   ...
   exports.associationfeGetAll = async (req, res) => {
    associationfe.find(function(err, data) {
        if(err){
            console.log(err);
        }
        else{
