...
const associationpe = require("./associationpe.model");
...
exports.associationpePost = async (req, res) => {
  try {
    ...
    const newassociationpe = new associationpe (result);
    await newassociationpe .save();
  ...
  exports.associationpeGetAll = async (req, res) => {
    associationpe.find(function(err, data) {
        if(err){
            console.log(err);
        }
        else{
